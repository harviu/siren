...
coord_dataset = dataio.Implicit3DWrapper(vol_dataset, sidelength=vol_dataset.shape, sample_fraction=opt.sample_frac)
...
summary_fn = partial(utils.write_volume_summary, vol_dataset)
