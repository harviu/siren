...
p.add_argument('--tracer_path', type=str, default=os.path.join(data_path,'tracer/torus_gw170817_traces_pruned_r250/tracers_00000050.h5part'),
...
tracer_dataset = dataio.Tracer(opt.tracer_path,opt.batch_size)
...
if opt.model_type == 'nerf':
    ...
    model = modules.SingleBVPNet(type=opt.model_type, in_features=3, hidden_features=64)
model.cuda()
